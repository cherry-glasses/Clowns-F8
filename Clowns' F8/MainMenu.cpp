...
bool MainMenu::Update(float _dt)
{
	...
	else if (controls_menu_created)
	{
		...
		if (accept_button->has_been_clicked) {
			ChangeControls(App->input->keyboard_buttons.buttons_to_use.ACCEPT);
		}
...
void MainMenu::ChangeControls(int control) {
	...
	//no canvia els valors del scancode
	/*while (scancode != SDL_SCANCODE_UNKNOWN)
	{
	...
	if (control == App->input->keyboard_buttons.buttons_to_use.ACCEPT) {

	App->input->keyboard_buttons.buttons_to_use.ACCEPT = scancode;


	accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.DECLINE) {

	App->input->keyboard_buttons.buttons_to_use.DECLINE = scancode;


	accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.UP) {

	App->input->keyboard_buttons.buttons_to_use.UP = scancode;


	accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.DOWN) {

	App->input->keyboard_buttons.buttons_to_use.DOWN = scancode;


	accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.RIGHT) {

	App->input->keyboard_buttons.buttons_to_use.RIGHT = scancode;


	accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.LEFT) {

	App->input->keyboard_buttons.buttons_to_use.LEFT = scancode;


	accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.ABILITY) {

	App->input->keyboard_buttons.buttons_to_use.ABILITY = scancode;


	accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.STATS) {

	App->input->keyboard_buttons.buttons_to_use.STATS = scancode;


	accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.PAUSE) {

	App->input->keyboard_buttons.buttons_to_use.PAUSE = scancode;
	...
	//canviar cada tecla del teclat en cada accio de la llsita de posibles accions

	if (App->input->GetKey(SDL_SCANCODE_SPACE) == KEY_DOWN) {



		if (control == App->input->keyboard_buttons.buttons_to_use.ACCEPT && control != App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.UP) {

			App->input->keyboard_buttons.buttons_to_use.ACCEPT = SDL_SCANCODE_SPACE;
	...
	if (control == App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ACCEPT && control != App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.UP) {

		App->input->keyboard_buttons.buttons_to_use.DECLINE = SDL_SCANCODE_SPACE;
	...
	if (control == App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ACCEPT && control != App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.UP) {

		App->input->keyboard_buttons.buttons_to_use.ABILITY = SDL_SCANCODE_SPACE;


		accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.ACCEPT && control != App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.UP) {

		App->input->keyboard_buttons.buttons_to_use.DOWN = SDL_SCANCODE_SPACE;


		accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.ACCEPT && control != App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.UP) {

		App->input->keyboard_buttons.buttons_to_use.LEFT = SDL_SCANCODE_SPACE;


		accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.ACCEPT && control != App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.UP) {

		App->input->keyboard_buttons.buttons_to_use.PAUSE = SDL_SCANCODE_SPACE;


		accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.ACCEPT && control != App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.UP) {

		App->input->keyboard_buttons.buttons_to_use.RIGHT = SDL_SCANCODE_SPACE;


		accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.ACCEPT && control != App->input->keyboard_buttons.buttons_to_use.UP) {

		App->input->keyboard_buttons.buttons_to_use.STATS = SDL_SCANCODE_SPACE;


		accept_button->has_been_clicked = false;

	}
	if (control == App->input->keyboard_buttons.buttons_to_use.UP && control != App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.ACCEPT) {

		App->input->keyboard_buttons.buttons_to_use.UP = SDL_SCANCODE_SPACE;
	...
	if (App->input->GetKey(SDL_SCANCODE_Q) == KEY_DOWN) {
		...
		if (control == App->input->keyboard_buttons.buttons_to_use.ACCEPT && control != App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.UP) {
			...
			App->input->keyboard_buttons.buttons_to_use.ACCEPT = SDL_SCANCODE_Q;
	...
	if (control == App->input->keyboard_buttons.buttons_to_use.DECLINE && control != App->input->keyboard_buttons.buttons_to_use.ACCEPT && control != App->input->keyboard_buttons.buttons_to_use.ABILITY && control != App->input->keyboard_buttons.buttons_to_use.DOWN && control != App->input->keyboard_buttons.buttons_to_use.LEFT && control != App->input->keyboard_buttons.buttons_to_use.PAUSE && control != App->input->keyboard_buttons.buttons_to_use.RIGHT && control != App->input->keyboard_buttons.buttons_to_use.STATS && control != App->input->keyboard_buttons.buttons_to_use.UP) {
		...
		App->input->keyboard_buttons.buttons_to_use.DECLINE = SDL_SCANCODE_Q;
