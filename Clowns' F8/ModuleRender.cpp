...
bool ModuleRender::BlitParticle(SDL_Texture * texture, int x, int y, const SDL_Rect * section, const SDL_Rect * rectSize, SDL_Color color, SDL_BlendMode blendMode, float speed, double angle) const
{
	bool ret = true;
	uint scale = App->window->GetScale();
