...
void Battle::ShowEntityInfo(Entity* _entity)
{
	...
	if (_entity != nullptr) 
	{
		...
		name_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + name_board.first, board_entity->position.second + name_board.second, _entity->name.c_str(), { 255, 255, 0, 255 }, App->gui_manager->default_font_used, -1000, -1000, 1920, nullptr, false);
		lvl_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, port_entity->position.first, board_entity->position.second + (life_board.second * 24), "Lvl: " + std::to_string(_entity->level), { 0, 100, 200, 255 }, App->gui_manager->default_font_used, -1000, -1000, 1920, nullptr, false);
		exp_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, lvl_entity->position.first + lvl_entity->area.w, board_entity->position.second + (life_board.second * 24), "Exp: " + std::to_string(_entity->exp), { 0, 100, 200, 255 }, App->gui_manager->default_font_used, -1000, -1000, 1920, nullptr, false);
		life_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + life_board.first, board_entity->position.second + life_board.second, "Hp: " + std::to_string(_entity->current_stats.Hp), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, -1000, 1920, nullptr, false);
		mana_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + mana_board.first, board_entity->position.second + mana_board.second, "Mana: " + std::to_string(_entity->current_stats.Mana), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, -1000, 1920, nullptr, false);
		atk_f_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + life_board.first, board_entity->position.second + (life_board.second * 7), "Atk_F: " + std::to_string(_entity->current_stats.AtkF), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, 1920, -1000, nullptr, false);
		def_f_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + mana_board.first, board_entity->position.second + (mana_board.second * 7), "Def_F: " + std::to_string(_entity->current_stats.DefF), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, 1920, -1000, nullptr, false);
		atk_s_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + life_board.first, board_entity->position.second + (life_board.second * 13), "Atk_S: " + std::to_string(_entity->current_stats.AtkS), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, 1920, -1000, nullptr, false);
		def_s_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + mana_board.first, board_entity->position.second + (mana_board.second * 13), "Def_S: " + std::to_string(_entity->current_stats.DefS), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, 1920, -1000, nullptr, false);
		crit_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + life_board.first, board_entity->position.second + (life_board.second * 19), "Crit: " + std::to_string(_entity->current_stats.Crit), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, 1920, -1000, nullptr, false);
		eva_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + mana_board.first, board_entity->position.second + (mana_board.second * 19), "Eva: " + std::to_string(_entity->current_stats.Eva), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, 1920, -1000, nullptr, false);
		attack_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + attack_board.first, board_entity->position.second + attack_board.second, ("Attack: " + _entity->attacks_names.Attack_name).c_str(), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, -1000, 1920, nullptr, false);
		ability1_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + ability_1_board.first, board_entity->position.second + ability_1_board.second, ("Ability 1: " + _entity->attacks_names.Ability_1_name).c_str(), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, -1000, 1920, nullptr, false);
		if (_entity->attacks_names.Ability_2_name != "")
		{
			ability2_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + ability_2_board.first, board_entity->position.second + ability_2_board.second, ("Ability 2: " + _entity->attacks_names.Ability_2_name).c_str(), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, -1000, 1920, nullptr, false);
			ability3_entity = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, board_entity->position.first + ability_3_board.first, board_entity->position.second + ability_3_board.second, ("Ability 3: " + _entity->attacks_names.Ability_3_name).c_str(), { 0, 0, 0, 255 }, App->gui_manager->default_font_used, -1000, -1000, 1920, nullptr, false);
		}
