...
void Battle::CreateOptionsIngame()
{
	...
	if (language)
	{
		...
		main_menu_label = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, main_menu_button->position.first + (button.w / 2), main_menu_button->position.second + (button.h / 2), "MAIN MENU", { 0, 0, 0, 255 }, App->gui_manager->default_font_used);
	...
	else
	{
		...
		main_menu_label = (GUILabel*)App->gui_manager->CreateGUILabel(GUI_ELEMENT_TYPE::GUI_LABEL, main_menu_button->position.first + (button.w / 2), main_menu_button->position.second + (button.h / 2), "MENÚ PRINCIPAL", { 0, 0, 0, 255 }, App->gui_manager->default_font_used);
