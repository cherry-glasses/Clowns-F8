...
void Hotdog::CurrentMovement(MOVEMENT _movement) {
	...
	case Entity::ATTACK_LEFT_FRONT:
		...
		App->entity_manager->ThrowAttack(objective_position, current_stats.AtkF, ENTITY_TYPE::ENTITY_ENEMY_BONEYMAN, false);
		current_turn = END_TURN;
		break;
	...
	case Entity::ABILITY_1_LEFT_FRONT:
		...
		App->entity_manager->ThrowAttack(objective_position, current_stats.AtkS, ENTITY_TYPE::ENTITY_ENEMY_BONEYMAN, true);
		current_turn = END_TURN;
		break;
